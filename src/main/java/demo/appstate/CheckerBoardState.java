...
public class CheckerBoardState extends BaseAppState implements ActionListener {
    ...
    public CheckerBoardState() {
        this(Constants.MAP_SIZE, Constants.CELL_SIZE);
    }

    public CheckerBoardState(float size, float cellSize) {
        this.size = size;
    ...
    private void createCheckerBoard() {
        ...
        mat.setColor("Color", new ColorRGBA(0.6f, 0.7f, 0.7f, 0.9f));
        mat.setFloat("CellSize", cellSize);
